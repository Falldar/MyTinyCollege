...
namespace MyTinyCollege.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                //dbujold: test for existing person (instructor or student) before register
                ...
                if (instructorOrStudent == null)
                {
                    ...
                    ModelState.AddModelError("", "Must be a student or proffessor at TinyCollege");
                    return View(model);
                }
                //end dbujold test for existing person
                ...
                if (result.Succeeded)
                {
                    //dbujold: is this a student or instructor -> give appropriate role
                    ...
                    //end dbujold assign student or instructor
